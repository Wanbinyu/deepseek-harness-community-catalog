...
| [dsh-mcp-lens](https://github.com/labmimors/dsh-mcp-lens) | Host 插件 | 将大型 MCP 工具目录置于两个模型可见工具之后：先检索精确 Schema，再调用明确的 server/tool 组合。 | `dsh plugin --profile web add https://github.com/labmimors/dsh-mcp-lens/releases/download/v0.1.0-rc.9/dsh-mcp-lens-0.1.0-rc.9.tgz` |
...
| `dsh-mcp-lens` | DeepSeek Harness `0.1.0-rc.6`；release `v0.1.0-rc.9`；Node.js `^22.19.0` 或 `>=24.0.0` |
